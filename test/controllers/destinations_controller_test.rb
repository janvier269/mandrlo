...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { airport: @destination.airport, location: @destination.location, section: @destination.section }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { airport: @destination.airport, location: @destination.location, section: @destination.section }
    assert_redirected_to destination_path(assigns(:destination))
  end
